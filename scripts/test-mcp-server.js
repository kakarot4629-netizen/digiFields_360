...
async function runTests() {
  ...
  await testCall(
    ...
    (res) => {
      ...
      return ['sobject_query', 'sobject_search', 'sobject_update', 'sobject_create', 'sobject_describe'].every(t => toolNames.includes(t));
    }
  );
  ...
  await testCall(
    ...
    (res) => {
      ...
      return text.includes('WO-001001') && text.includes('Generator Overheating Check');
    }
  );
  ...
  if (failed > 0) {
    ...
    console.log('✨ All Mobile MCP Server verification tests passed successfully!');
    process.exit(0);
  }
}
